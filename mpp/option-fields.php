...
class OptionSettings{
	...
	public function wph_setup_fields() {
		...
		foreach( $fields as $field ){
			...
			add_settings_field( $field['id'], $field['label'], array( $this, 'wph_field_callback' ), $field['page'], $field['section'], $field );
	...
	public function wph_field_callback( $field ) {
		...
		switch ( $field['type'] ) {
				case 'media':
					...
					//printf('<img src="%s" style="width: 100%; height:350px">',$value);
					break;
				case 'radio':
				case 'checkbox':
